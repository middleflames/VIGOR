...
class REFER:
	...
	def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
		...
		if dataset != "talk2car":
			...
			ref_file = osp.join(self.DATA_DIR,"talk2car_coco.p")
		self.data = {}
		...
		if dataset != "talk2car":
			...
			instances_file = osp.join(self.DATA_DIR,"talk2car_coco.json")
...
if __name__ == '__main__':
	refer = REFER(data_root="/home/haw23016/codes/rec/UniRef/data/",dataset='talk2car', splitBy='google')
	data = refer.data
	print(data["refs"][0])
